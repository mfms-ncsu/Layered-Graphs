...
def parse_arguments():
    ...
    parser.add_argument("-n", "--name",
                        help="output to file instead of stdout\n"
                           + "arg is base name of the file and the graph name,"
                           + " if _ (underscore), use standardized name")
...
#    ...
#    e source_m target_m
def print_graph( file_stream, degree_var, seed, graph_name ):
    file_stream.write("c generated by {} on {}\n".format(version(), date()))
    for arg in args.__dict__:
        file_stream.write("c {:15s} {}\n".format(arg, args.__dict__[arg]))
    file_stream.write("t {} {} {} {}\n"
                       .format(graph_name,
...
if __name__ == "__main__":
    ...
    if args.name:
        ...
        output_stream = open(graph_name + ".sgf", 'w')
    print_graph(output_stream, degree_var, seed, graph_name)
